...
FTB StoneBlock 3 日本語化ファイルのインストール方法を詳しく説明します。

## 📋 事前準備

### 必要なもの

- ✅ FTB StoneBlock 3がインストール済み
- ✅ Minecraft 1.18.2
- ✅ 日本語化ファイル（本リポジトリから入手）
...
| ランチャー | デフォルトパス |
|-----------|---------------|
| **CurseForge** | `C:\Users\<ユーザー名>\curseforge\minecraft\Instances\FTB StoneBlock 3` |
| **FTB App** | `C:\Users\<ユーザー名>\FTBApp\instances\FTB StoneBlock 3` |
| **MultiMC/Prism** | `<MultiMCフォルダ>\instances\FTB StoneBlock 3\.minecraft` |
| **AT Launcher** | `C:\Users\<ユーザー名>\ATLauncher\instances\FTB StoneBlock 3` |

インスタンスフォルダが分からない場合:
1. ランチャーでStoneBlock 3を右クリック
...
1. [Releases](https://github.com/pazakasin/FTB-StoneBlock3-Japanese/releases)ページを開く
2. 最新版のZIPファイルをダウンロード
   - 例: `FTB-StoneBlock3-JP-v1.0.0.zip`
...
1. Minecraftを起動
2. タイトル画面で「設定」（Options）を開く
3. 「リソースパック」（Resource Packs）を選択
...
**解決方法**: [Issues](https://github.com/pazakasin/FTB-StoneBlock3-Japanese/issues)で翻訳リクエストを送ってください
...
問題が解決しない場合:
- [Issues](https://github.com/pazakasin/FTB-StoneBlock3-Japanese/issues)で質問
- 上記のトラブルシューティングも参照

---

**インストール成功を祈っています！楽しいStoneBlock 3ライフを！ 🎮**
